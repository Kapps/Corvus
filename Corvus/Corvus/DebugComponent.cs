...
namespace Corvus {
	...
	public class DebugComponent : DrawableGameComponent {
		...
		public override void Draw(GameTime gameTime) {
			...
			CorvusGame.Instance.SpriteBatch.DrawString(Font, "Position: " + TempPlayer.TempInstance.entity.Position, new Vector2(10, GraphicsDevice.Viewport.Height - 50), Color.Yellow);
			base.Draw(gameTime);
		}
	}
}
